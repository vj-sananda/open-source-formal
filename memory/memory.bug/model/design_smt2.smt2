; SMT-LIBv2 description generated by Yosys 0.9+1706 (git sha1 5791c52e, clang 6.0.0-1ubuntu2 -fPIC -Os)
...
(declare-fun |memory#2| (|memory_s|) (_ BitVec 8)) ; $auto$rtlil.cc:2358:Anyseq$178
...
(define-fun |memory#5| ((state |memory_s|)) (_ BitVec 8) (select (|memory#3#0| state) (|memory_m:R0A bank3| state))) ; $auto$wreduce.cc:460:run$147 [7:0]
...
(define-fun |memory#8| ((state |memory_s|)) (_ BitVec 8) (ite (|memory#7| state) (|memory#5| state) (|memory#2| state))) ; $auto$wreduce.cc:460:run$151 [7:0]
...
(define-fun |memory#10| ((state |memory_s|)) (_ BitVec 8) (select (|memory#9#final| state) (|memory_m:R0A bank2| state))) ; $auto$wreduce.cc:460:run$148 [7:0]
...
(define-fun |memory#12| ((state |memory_s|)) (_ BitVec 8) (ite (|memory#11| state) (|memory#10| state) (|memory#8| state))) ; $auto$wreduce.cc:460:run$152 [7:0]
...
(define-fun |memory#14| ((state |memory_s|)) (_ BitVec 8) (select (|memory#13#0| state) (|memory_m:R0A bank1| state))) ; $auto$wreduce.cc:460:run$149 [7:0]
...
(define-fun |memory#18| ((state |memory_s|)) (_ BitVec 8) (select (|memory#17#0| state) (|memory_m:R0A bank0| state))) ; $auto$wreduce.cc:460:run$150 [7:0]
...
(declare-fun |memory#22| (|memory_s|) (_ BitVec 8)) ; $auto$rtlil.cc:2358:Anyseq$170
; yosys-smt2-anyseq memory#23 8 $auto$setundef.cc:524:execute$163
(declare-fun |memory#23| (|memory_s|) (_ BitVec 8)) ; $auto$rtlil.cc:2358:Anyseq$164
...
(declare-fun |memory#26| (|memory_s|) (_ BitVec 8)) ; $auto$rtlil.cc:2358:Anyseq$168
; yosys-smt2-anyseq memory#27 8 $auto$setundef.cc:524:execute$159
(declare-fun |memory#27| (|memory_s|) (_ BitVec 8)) ; $auto$rtlil.cc:2358:Anyseq$160
...
(declare-fun |memory#32| (|memory_s|) (_ BitVec 8)) ; $auto$rtlil.cc:2358:Anyseq$174
...
(declare-fun |memory#34| (|memory_s|) (_ BitVec 8)) ; $auto$rtlil.cc:2358:Anyseq$172
...
(declare-fun |memory#37| (|memory_s|) (_ BitVec 8)) ; $auto$rtlil.cc:2358:Anyseq$158
...
(declare-fun |memory#39| (|memory_s|) (_ BitVec 8)) ; $auto$rtlil.cc:2358:Anyseq$176
...
(declare-fun |memory#42| (|memory_s|) (_ BitVec 8)) ; $auto$rtlil.cc:2358:Anyseq$166
...
(declare-fun |memory#44| (|memory_s|) (_ BitVec 8)) ; $auto$rtlil.cc:2358:Anyseq$162
...
(declare-fun |testbench#10| (|testbench_s|) (_ BitVec 1)) ; $auto$rtlil.cc:2358:Anyseq$188
; yosys-smt2-anyseq testbench#11 1 $auto$setundef.cc:524:execute$185
(declare-fun |testbench#11| (|testbench_s|) (_ BitVec 1)) ; $auto$rtlil.cc:2358:Anyseq$186
